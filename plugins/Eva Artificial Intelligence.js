...
if (conf.LANG == 'EN') {
    ...
    already_on = 'jinusir artificial intelligence is already fully functional.'
    already_off = 'jinusir artificial intelligence is currently running semi-functional.'
    succ_on = 'jinusir Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'jinusir Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'AZ') {
