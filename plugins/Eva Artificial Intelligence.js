...
The all input datas must be english. We are using google translate before send users inputs./* Codded by Phaticusthiccy
Eva, The Phaticusthiccy's Multifunctional Artificial Intelligence
...
if (conf.LANG == 'AZ') {
    fulleva_dsc = 'Tam funksional Eva xüsusiyyətlərini aktivləşdirir. Hesabınızı bir chatbot halına gətirin!'
    already_on = 'Ajuser süni intellekt onsuz da tam işlək vəziyyətdədir.'
    already_off = 'Ajuser AI hazırda yarı funksionaldır.'
    succ_on = 'Ajuser Tamamilə İşlədi! Xahiş edirəm bir az gözləyin! ✅'
    succ_off = 'Ajuser Yarı İşləkdir! Xahiş edirəm bir az gözləyin! ☑️'
    wr_cmd = 'Zəhmət olmasa *off* və ya *on* əmrindən istifadə edin.'
}
if (conf.LANG == 'RU') {
    fulleva_dsc = 'Активирует полнофункциональные функции Ajuser. Превратите свой аккаунт в чат-бота!'
    already_on = 'Искусственный интеллект Ajuser уже полностью функционален.'
    already_off = 'Ajuser AI в настоящее время частично функционирует'
    succ_on = 'Ajuser открылась полностью функционально! Подождите немного! ✅'
    succ_off = 'Ajuser настроена на полуфункциональность! Подождите немного! ☑️'
    wr_cmd = 'Пожалуйста, просто используйте команду *off* или *on*.'
}
if (conf.LANG == 'ES') {
    fulleva_dsc = 'Activa todas las funciones funcionales de Ajuser. ¡Convierta su cuenta en un chatbot!'
    already_on = 'La inteligencia artificial de Ajuser ya es completamente funcional.'
    already_off = 'Ajuser AI es actualmente semi-funcional.'
    succ_on = '¡Ajuser abrió completamente funcionalmente! ¡Por favor espere un poco! ✅'
    succ_off = '¡Ajuser se pone semifuncional! ¡Por favor espere un poco! ☑️'
    wr_cmd = 'Utilice el comando *off* o *on*.'
}
if (conf.LANG == 'HI') {
    fulleva_dsc = 'पूरी तरह कार्यात्मक Ajuser सुविधाओं को सक्रिय करता है। अपने खाते को चैटबॉट में बदलें!'
    already_on = 'ईवा आर्टिफिशियल इंटेलिजेंस पहले से ही पूरी तरह कार्यात्मक है'
    already_off = 'ईवा एआई वर्तमान में अर्ध-कार्यात्मक है'
    succ_on = 'ईवा पूरी तरह कार्यात्मक रूप से खुल गई! कृपया थोड़ी प्रतीक्षा करें! ✅'
    succ_off = 'अर्ध-कार्यात्मक करने के लिए ईवा सेट! कृपया थोड़ी प्रतीक्षा करें! ☑️'
